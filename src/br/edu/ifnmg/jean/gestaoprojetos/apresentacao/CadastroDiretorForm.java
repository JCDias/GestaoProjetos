...
public class CadastroDiretorForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(btnCadastrar, javax.swing.GroupLayout.DEFAULT_SIZE, 45, Short.MAX_VALUE)
    ...
    private void txtConfirmaSenhaFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_txtConfirmaSenhaFocusLost
        ...
        boolean valida = diretorBO.validaSenha(txtSenha.getText().trim(), txtConfirmaSenha.getText().trim());
        if(valida){
            txtSenha.setText("");
            txtConfirmaSenha.setText("");
            JOptionPane.showMessageDialog(null, "As senhas digitadas não conferem!", "Cadastro de Diretor", JOptionPane.WARNING_MESSAGE);
        }
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if(valida == null){
            //chamar criptografia, setar objeto e chamar o criar
        }else{
